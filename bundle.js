...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__src_local__ = __webpack_require__(201);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__src_mouse__ = __webpack_require__(202);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__src_select__ = __webpack_require__(203);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_7__src_selectAll__ = __webpack_require__(231);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_12__src_touch__ = __webpack_require__(232);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_13__src_touches__ = __webpack_require__(233);
...
// global variables 
var w = __WEBPACK_IMPORTED_MODULE_0_d3__["g" /* select */]('#time-line').node().clientWidth;
var h = 500;

var canvas = __WEBPACK_IMPORTED_MODULE_0_d3__["g" /* select */]('#time-line').append('svg').attr('id', 'canvas').style('height', h).style('width', w).style('background', 'rgb(12, 33, 58)');
...
// x scale
var x = __WEBPACK_IMPORTED_MODULE_0_d3__["f" /* scaleLinear */]()
    .domain([maxX, minX])
    .range([w - 80, 0]);

// xaxis generator
var xAxis = __WEBPACK_IMPORTED_MODULE_0_d3__["a" /* axisBottom */]()
    .scale(x)
    .ticks(28)
...
// y axis generator
var yAxis = __WEBPACK_IMPORTED_MODULE_0_d3__["b" /* axisLeft */]()
    .scale(y)
    .tickPadding(15)
    .tickSize(0);
...
var lineGen = __WEBPACK_IMPORTED_MODULE_0_d3__["e" /* line */]()
    .defined(function(d) {
        if (d.rate == null) {
            console.log('d')
            return false
    ...
    .curve(__WEBPACK_IMPORTED_MODULE_0_d3__["c" /* curveCardinal */]);
...
__WEBPACK_IMPORTED_MODULE_0_d3__["g" /* select */]('#xAxis').selectAll('.tick')
    .select('text')
...
__WEBPACK_IMPORTED_MODULE_0_d3__["h" /* selectAll */]('.filter').on('click', function() {
...
function changeLineData(that) {
    ...
    var line = __WEBPACK_IMPORTED_MODULE_0_d3__["g" /* select */]('#plotted-line');
    var lineClass = line.attr('class');

    if(lineClass.indexOf(dataClass) == -1) {

        activeData = dataArr[dataFilter].data;
        __WEBPACK_IMPORTED_MODULE_0_d3__["g" /* select */]('.selected').attr('class', 'filter');
        __WEBPACK_IMPORTED_MODULE_0_d3__["g" /* select */](that).attr('class', 'selected filter');
        line.remove()
...
// definte year labels
var yearLabels = __WEBPACK_IMPORTED_MODULE_0_d3__["g" /* select */]('#canvas').selectAll('.year-label').data(years);
...
function openCloseLine(that, data) {
    ...
    if(lineOpen == true && __WEBPACK_IMPORTED_MODULE_0_d3__["g" /* select */]('.selected-year').node() == that) {

        __WEBPACK_IMPORTED_MODULE_0_d3__["h" /* selectAll */]('.marker-group').remove();

        dataSlice1 = 0;
        dataSlice2 = 27;

        __WEBPACK_IMPORTED_MODULE_0_d3__["g" /* select */]('.selected-year').attr('class', 'year-label');
        lineOpen = false;
        x = __WEBPACK_IMPORTED_MODULE_0_d3__["f" /* scaleLinear */]()
            .domain([maxX, minX])
            .range([w - 80, 0]);

        xAxis = __WEBPACK_IMPORTED_MODULE_0_d3__["a" /* axisBottom */]()
            .scale(x)
            .ticks(28)
        ...
        __WEBPACK_IMPORTED_MODULE_0_d3__["g" /* select */]('#xAxis')
            .transition()
            .duration(800)
            .call(xAxis);

        lineGen = __WEBPACK_IMPORTED_MODULE_0_d3__["e" /* line */]()
                .defined(function(d) {
                    if (d.rate == null) {
                        console.log('d')
                        return false
        ...
        var lineClasses =  __WEBPACK_IMPORTED_MODULE_0_d3__["g" /* select */]('#plotted-line').attr('class');
        __WEBPACK_IMPORTED_MODULE_0_d3__["g" /* select */]('#plotted-line').remove()
        ...
        __WEBPACK_IMPORTED_MODULE_0_d3__["h" /* selectAll */]('.year-label').transition().duration(900).attr('y', (h *.595) - 20)

    // if the user clicks a year label
    } else {
        __WEBPACK_IMPORTED_MODULE_0_d3__["g" /* select */]('.selected-year').attr('class', 'year-label');

        __WEBPACK_IMPORTED_MODULE_0_d3__["g" /* select */](that).attr('class', 'selected-year year-label')
        ...
        __WEBPACK_IMPORTED_MODULE_0_d3__["g" /* select */]('#plotted-line')
            .transition()
            .delay(250)
            .duration(1400)
            .attr('d', lineGen(activeData.slice(dataSlice1, dataSlice2)));

        __WEBPACK_IMPORTED_MODULE_0_d3__["h" /* selectAll */]('.year-label').transition().duration(900).attr('y', 20)
...
function drawMarkers(year) {
    ...
    var markers = __WEBPACK_IMPORTED_MODULE_0_d3__["g" /* select */]('#canvas').selectAll('.marker').data(markersArr);
    var circleGen = __WEBPACK_IMPORTED_MODULE_0_d3__["d" /* geoCircle */]();
    ...
    if(!lineOpen) {
        ...
        markers.enter()
            ...
            .attr('transform', function(d) {
                ...
                var scale = __WEBPACK_IMPORTED_MODULE_0_d3__["f" /* scaleLinear */]()
                                .domain([0, 365])
        ...
        __WEBPACK_IMPORTED_MODULE_0_d3__["h" /* selectAll */]('.marker-group')
            .append('line')
            .attr('height', 10)
            .attr('width', 10)
            .attr('y1', 0)
...
function handleClickedMarker(that, data) {
    ...
    var selectedMarker = __WEBPACK_IMPORTED_MODULE_0_d3__["g" /* select */]('.selected-marker').node();

    var xcoord = parseFloat(__WEBPACK_IMPORTED_MODULE_0_d3__["g" /* select */](that).attr('transform').split('(')[1].split(',')[0]);
    ...
    if(selectedMarker == null) {
        ...
        __WEBPACK_IMPORTED_MODULE_0_d3__["g" /* select */](that)
    ...
    // if clicked on a different marker than the open one
        ...
        __WEBPACK_IMPORTED_MODULE_0_d3__["g" /* select */]('.selected-marker')
            .select('circle')
            .transition()
            .duration(150)
            .style('cy', '0');
        ...
        __WEBPACK_IMPORTED_MODULE_0_d3__["g" /* select */]('.marker-text').remove();
...
var	fixUrls = __webpack_require__(468);
...
/* harmony namespace reexport (by used) */ __webpack_require__.d(__webpack_exports__, "d", function() { return __WEBPACK_IMPORTED_MODULE_13_d3_geo__["a"]; });
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return __WEBPACK_IMPORTED_MODULE_3__src_circle__["b"]; });
...
/* harmony reexport (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return __WEBPACK_IMPORTED_MODULE_22__src_curve_cardinal__["b"]; });
...
// module
exports.push([module.i, "html,\nbody {\n  width: 100%;\n  height: 100%;\n  background-color: #0c213a;\n  min-width: 1000px;\n  font-family: \"Helvetica Neue\", Helvetica, Arial, sans-serif; }\n\n.title-container {\n  height: 100%;\n  width: 100%;\n  background-image: url(http://russomatt.com/greece/img/background-blue.jpg);\n  background-size: cover;\n  position: relative; }\n  .title-container .title {\n    position: absolute;\n    bottom: 3em;\n    left: 3em; }\n    .title-container .title h1 {\n      font-size: 4em;\n      background-color: #fafafa;\n      margin: 0;\n      display: inline-block;\n      padding: 0.25em 0.5em;\n      line-height: 0.8em;\n      font-weight: 900; }\n\n.intro {\n  color: #fff;\n  font-size: 1.1em;\n  font-weight: 300;\n  padding: 10em 3em 2em 4em;\n  display: table;\n  width: 100%; }\n  .intro .intro-welcome {\n    padding: 0.5em 0 0 0;\n    font-size: 2em;\n    font-weight: 900;\n    border-top: 3px solid #fff;\n    margin-top: -1px; }\n  .intro .intro-text {\n    padding: 1.1em 0 0 0;\n    border-top: 1px solid #fff; }\n\n.time-line-container {\n  padding: 5em 0;\n  display: table;\n  width: 100%; }\n\n#time-line {\n  padding: 0; }\n\n.filters {\n  padding: 4em 2em 4em 4.5em; }\n\n.filter {\n  color: #fff;\n  font-size: 1.1em;\n  font-weight: 300;\n  transition: .1s;\n  cursor: pointer;\n  padding: 0.25em 0; }\n  .filter.selected {\n    font-size: 1.1em;\n    font-weight: 900;\n    transition: .2s; }\n\n.axis path {\n  stroke: #fff; }\n\n.axis .tick line {\n  display: none; }\n\n.axis .tick text {\n  font-family: \"Helvetica Neue\", Helvetica, Arial, sans-serif;\n  font-size: 1.15em;\n  fill: #fff;\n  font-weight: 100; }\n\n.axis#xAxis g:last-child text {\n  transform: translate(8px, 0); }\n\n.year-label {\n  cursor: pointer;\n  fill: #fff;\n  font-family: \"Helvetica Neue\", Helvetica, Arial, sans-serif;\n  font-size: 0.95em;\n  font-weight: 300;\n  letter-spacing: 0.015em;\n  transition: 0.2s; }\n  .year-label.selected-year {\n    transition: 0.2s;\n    font-size: 1.65em;\n    font-weight: 900;\n    border-bottom: 1px solid #fff; }\n\n.marker-group {\n  cursor: pointer; }\n  .marker-group:hover circle {\n    fill: #fff !important; }\n  .marker-group:hover line {\n    stroke: #fff !important; }\n\n.marker-content {\n  display: table;\n  font-family: \"Helvetica Neue\", Helvetica, Arial, sans-serif;\n  font-weight: 300;\n  width: 275px;\n  font-size: 0.9em;\n  color: #fff; }\n  .marker-content.marker-content-left {\n    text-align: right; }\n  .marker-content .marker-content-date {\n    font-weight: 900;\n    margin-bottom: 0.75em;\n    color: #fff;\n    border-top: 2px solid #F9D108;\n    padding-top: 0.4em; }\n", ""]);
